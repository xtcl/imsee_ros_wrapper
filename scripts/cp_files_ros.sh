...
WRAPPER_OUTPUT_DIR=$BASE_DIR/../../../devel/lib/imsee_ros_wrapper
DRIVER_BASE_DIR=$BASE_DIR/driver/lib
MNN_CONFIG_DIR=$BASE_DIR/detector/config
MNN_LIB_BASE_DIR=$BASE_DIR/detector/lib
